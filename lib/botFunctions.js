...
exports.generateMessageTag = (epoch) => {
    ...
    if (epoch)
        tag += '.--' + epoch; // anexar epoch se fornecido
    return tag;
}
...
exports.tanggal = (numer) => {
    ...
    myDays = ['Segunda-feira','Terça-feira','Quarta-feira','Quinta-feira','Sexta-feira','Sábado','Domingo']; 
...
exports.logic = (check, inp, out) => {
    if (inp.length !== out.length) throw new Error('Input e Output devem ter o mesmo tamanho')
    for (let i in inp)
...
exports.getSizeMedia = (path) => {
    return new Promise((resolve, reject) => {
        if (/http/.test(path)) {
            ...
            reject('Erro: tipo de caminho desconhecido')
        }
    })
}
...
exports.smsg = (conn, m, store) => {
    ...
    if (m.message) {
        ...
        if (m.quoted) {
            ...
            /**
             * Deletar mensagem citada
             * @returns 
             */
            m.quoted.delete = () => conn.sendMessage(m.quoted.chat, { delete: vM.key })

           /**
            * Copiar e encaminhar mensagem citada
            * @param {*} jid 
            * @param {*} forceForward 
            * @param {*} options 
            * @returns 
           */
            ...
            /**
              * Baixar mídia da mensagem citada
              * @returns
            */
    ...
    /**
     * Copiar e encaminhar esta mensagem
     * @param {*} jid 
     * @param {*} forceForward 
     * @param {*} options 
     * @returns 
